...
| 6 — Offline sync queue | #7 | ✅ **DONE** (PR #16 merged; MVP deployed) | `feat/issue-7-offline-sync` → [PR #16](https://github.com/gohlihan/couple-spending/pull/16) |
...
plus an authenticated refetch before local deletion. Migrations `0003` through `0006` are applied to the linked Supabase project;
